...
// MetricsController operations for Metrics
type MetricsController struct {
	beego.Controller
}

// URLMapping ...
func (c *MetricsController) URLMapping() {
...
// @Param	body		body 	models.Metrics	true		"body for Metrics content"
// @Success 201 {int} models.Metrics
// @Failure 403 body is empty
// @router / [post]
func (c *MetricsController) Post() {
	var v models.Metrics
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddMetrics(&v); err == nil {
...
// @router /:id [get]
func (c *MetricsController) GetOne() {
...
func (c *MetricsController) GetAll() {
	...
	l, err := models.GetAllMetrics(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *MetricsController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteMetrics(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
